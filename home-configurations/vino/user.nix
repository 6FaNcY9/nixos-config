# User-level Home Manager settings for vino
#
# This file contains user-specific implementation details that are not
# host-specific and not part of the composition skeleton in default.nix.
# Covers: session environment, cursor, XDG, GTK quirks, stylix targets,
# program identity (git, btop), and validation warnings.
{
  lib,
  config,
  pkgs,
